...
public class SugarTestParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SugarTest");
  ...
  { 
    SugarTestParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SugarTestParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SugarTestParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SugarTestParseControllerGenerated.class);
    }
  ...
  { 
    return SugarTestParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
